    ...
    <GuestLayout>
        ...
        <div class="py-12">
            <div class="w mx-auto sm:px-6 lg:px-8">
                <div v-if="errors.data && errors.data.length === 0" class="my-24 border-purple-500 overflow-hidden border-2 shadow-sm sm:rounded-lg w-52 mx-auto">
				...
				<div v-else
				  class=" overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="flex flex-col items-center">
                        <Table class="" endpoint="/offers" :rows="errors.data" />
                    </div>
